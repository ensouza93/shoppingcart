...
public class VendaEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Venda> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT v FROM Venda v LEFT JOIN FETCH v.itens WHERE v.id = :entityId ORDER BY v.id",
						Venda.class);
	...
	public List<Venda> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Venda> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT v FROM Venda v LEFT JOIN FETCH v.itens ORDER BY v.id",
						Venda.class);
